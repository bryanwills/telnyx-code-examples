...
```bash
docker build -t ai-negotiation-practice-phone .
docker run --env-file .env -p 5000:5000 ai-negotiation-practice-phone
```
...
| `PRACTICE_NUMBER` | Phone number in E.164 format | Yes |
