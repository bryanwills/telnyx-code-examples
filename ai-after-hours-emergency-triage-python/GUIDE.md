# Build an AI After-Hours Emergency Triage
...
```bash
curl http://localhost:5000/triage-log | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-after-hours-emergency-triage-python/README.md)
