# AI After-Hours Emergency Triage
...
A production-ready **ai after-hours emergency triage** built with Python, Flask, and AI Inference.
...
cd telnyx-code-examples/ai-after-hours-emergency-triage-python
cp .env.example .env
...
curl -X GET http://localhost:5000/triage-log \
...
```bash
docker build -t ai-after-hours-emergency-triage-python .
docker run --env-file .env -p 5000:5000 ai-after-hours-emergency-triage-python
```
