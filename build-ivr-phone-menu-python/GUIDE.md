...
A production-ready **production-ready ivr system using telnyx voice api and flask** built with Python, Flask, and Migration, Number Porting, Voice.
...
The entire app is in `app.py` (215 lines). Here's how it's structured:
...
- **`gather_dtmf()`** — gather dtmf
- **`transfer_call()`** — transfer call
- **`hangup_call()`** — hangup call
- **`initialize_call_state()`** — initialize call state
