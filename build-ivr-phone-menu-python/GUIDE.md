...
Everything lives in `app.py` (215 lines). Here's what each piece does.
...
```bash
curl http://localhost:5000/webhooks/call/status | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/build-ivr-phone-menu-python/README.md)
