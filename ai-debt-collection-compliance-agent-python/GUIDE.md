...
A production-ready **ai debt collection compliance agent** built with Python, Flask, and Voice, AI Inference.
...
The entire app is in `app.py` (107 lines). Here's how it's structured:
