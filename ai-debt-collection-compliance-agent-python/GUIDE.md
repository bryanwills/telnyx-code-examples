# Build an AI Debt Collection Compliance Agent
...
Everything lives in `app.py` (107 lines). Here's what each piece does.

### Starting the Workflow

**`start_collection()`** — Kicks off the main workflow. Validates the request, creates the record, and initiates the Telnyx API calls.
...
```bash
curl http://localhost:5000/logs | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-debt-collection-compliance-agent-python/README.md)
