# Build an AI Property Management Maintenance Line
...
cd telnyx-code-examples/ai-property-management-maintenance-line-python
cp .env.example .env
...
```bash
curl http://localhost:5000/work-orders | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-property-management-maintenance-line-python/README.md)
