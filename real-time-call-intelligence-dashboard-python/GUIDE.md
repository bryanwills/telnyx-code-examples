...
A production-ready **real-time call intelligence dashboard** built with Python, Flask, and AI Inference.
...
The entire app is in `app.py` (167 lines). Here's how it's structured:
...
- **`analyze_segment()`** — analyze segment
