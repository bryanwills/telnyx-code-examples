...
- **`list_bookings()`** — Returns all bookings with metadata and pagination.
- **`assign_tech()`** — Processes assign tech request and returns result.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/service-booking-dispatch-python/README.md)
