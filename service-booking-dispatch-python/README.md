...
| `DISPATCH_SLACK_WEBHOOK` | Slack incoming webhook URL for dispatch notifications | No |
...
| `POST` | `/bookings/<int:idx>/assign` | Assign to a team member (triggers notifications) |
| `GET` | `/techs` | List all techs |
