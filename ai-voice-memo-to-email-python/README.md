...
```bash
docker build -t ai-voice-memo-to-email .
docker run --env-file .env -p 5000:5000 ai-voice-memo-to-email
```
...
| `MEMO_NUMBER` | Phone number in E.164 format | Yes |
| `DEFAULT_EMAIL` | Default Email | No |
