...
| `CONF_NUMBER` | Phone number in E.164 format | Yes |
...
| `POST` | `/conference/<cid>/invite` | `POST` /conference/<cid>/invite |
| `POST` | `/conference/<cid>/poll` | `POST` /conference/<cid>/poll |
| `GET` | `/conference/<cid>/results` | `GET` /conference/<cid>/results |
