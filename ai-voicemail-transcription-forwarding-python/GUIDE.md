...
A production-ready **ai voicemail transcription & forwarding** built with Python, Flask, and SMS/MMS, AI Inference.
...
- **`classify_and_summarize()`** — classify and summarize
- **`send_sms()`** — send sms
...
curl -X GET http://localhost:5000/voicemails \
