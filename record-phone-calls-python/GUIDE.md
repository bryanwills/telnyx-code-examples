...
- **`stop_recording_endpoint()`** — Processes stop recording endpoint request and returns result.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-python/README.md)
