...
| `POST` | `/calls/<call_control_id>/recording/start` | `POST` /calls/<call_control_id>/recording/start |
| `POST` | `/calls/<call_control_id>/recording/stop` | `POST` /calls/<call_control_id>/recording/stop |
| `POST` | `/calls/<call_control_id>/hangup` | `POST` /calls/<call_control_id>/hangup |
