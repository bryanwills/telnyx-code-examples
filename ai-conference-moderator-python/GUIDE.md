...
A production-ready **ai conference moderator** built with Python, Flask, and Voice, AI Inference, Conferencing.
...
| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/meetings/create` | Create |
| `POST` | `/webhooks/voice` | Telnyx webhook handler |
| `POST` | `/meetings/<mid>/advance` | Advance |
| `POST` | `/meetings/<mid>/mute/<call_id>` | <Call Id> |
| `GET` | `/meetings` | Meetings |
| `GET` | `/meetings/<mid>` | <Mid> |
