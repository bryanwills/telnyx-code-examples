# AI Sales Demo Booking Agent

> AI Sales Demo Booking Agent — inbound calls, AI qualifies the lead, books a demo on the calendar.

## What You'll Build

A production-ready **ai sales demo booking agent** built with Python, Flask, and AI Inference.
...
cd telnyx-code-examples/ai-sales-demo-booking-agent-python
cp .env.example .env
...
```bash
docker build -t ai-sales-demo-booking-agent-python .
docker run --env-file .env -p 5000:5000 ai-sales-demo-booking-agent-python
```
