# Build an AI Sales Demo Booking Agent
...
```bash
curl http://localhost:5000/leads | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-sales-demo-booking-agent-python/README.md)
