# Build an After-Hours Nurse Triage
...
Everything lives in `app.py` (160 lines). Here's what each piece does.
...
- **`notify_nurse()`** — Sends notifications through configured channels (SMS, Slack, email) based on event severity.
...
```bash
curl http://localhost:5000/triage/queue | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/after-hours-nurse-triage-python/README.md)
