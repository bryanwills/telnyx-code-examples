...
- **`list_sessions()`** — Returns all active sessions with caller info.
- **`get_session()`** — Fetches session by ID with full details.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-sales-coach-whisper-python/README.md)
