...
Team members call in daily standup updates. AI asks the 3 standup questions, extracts structured data, and posts summaries to Slack with blocker flags.
...
| Product | Role |
|---------|------|
| Voice API | Standup collection |
| Inference | Update extraction |
| Webhooks | Slack posting |
