...
A production-ready **restaurant reservation & waitlist** built with Python, Flask, and Voice, AI Inference.
...
The entire app is in `app.py` (104 lines). Here's how it's structured:
...
| `POST` | `/waitlist/add` | Add |
| `POST` | `/waitlist/<int:idx>/ready` | Ready |
