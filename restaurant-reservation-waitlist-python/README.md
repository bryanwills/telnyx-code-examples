...
| `HOST_SLACK_WEBHOOK` | Slack incoming webhook URL for host notifications | No |
...
| Method | Path | Description |
|--------|------|-------------|
| `POST` | `/waitlist/add` | Create new record |
| `POST` | `/waitlist/<int:idx>/ready` | Notify customer that service is ready |
| `GET` | `/reservations` | List all reservations |
| `GET` | `/waitlist` | List all waitlist |
