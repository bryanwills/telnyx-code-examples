...
A production-ready **ai competitive win/loss call analyzer** built with Python, Flask, and AI Inference.
...
The entire app is in `app.py` (52 lines). Here's how it's structured:
