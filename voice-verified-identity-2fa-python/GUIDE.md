# Build a Voice-Verified Identity + 2FA
...
Everything lives in `app.py` (232 lines). Here's what each piece does.
...
- **`send_verification()`** — Makes an API call and processes the response.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-verified-identity-2fa-python/README.md)
