...
A production-ready **hotel guest services line** built with Python, Flask, and Voice, AI Inference.
...
The entire app is in `app.py` (125 lines). Here's how it's structured:
...
| `POST` | `/requests/<int:idx>/complete` | Complete |
