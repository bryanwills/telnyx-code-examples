...
A production-ready **ai live call participant** built with Python, Flask, and Voice, AI Inference, Media Streaming, Conferencing.
...
| **Products** | Voice, AI Inference, Media Streaming, Conferencing |
| **Channels** | voice |
...
| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/conferences/create` | Create |
| `POST` | `/webhooks/voice` | Telnyx webhook handler |
| `POST` | `/webhooks/media` | Telnyx webhook handler |
| `GET` | `/conferences` | Conferences |
| `GET` | `/conferences/<name>/transcript` | Transcript |
| `POST` | `/conferences/<name>/ask` | Ask |
