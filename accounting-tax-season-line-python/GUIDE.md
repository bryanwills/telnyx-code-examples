# Build an Accounting Firm Tax Season Line
...
```bash
curl http://localhost:5000/clients | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/accounting-tax-season-line-python/README.md)
