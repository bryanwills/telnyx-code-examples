...
A production-ready **rent collection escalation** built with Python, Flask, and Voice.
...
| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/collections/run` | Run |
| `POST` | `/webhooks/voice` | Telnyx webhook handler |
| `GET` | `/tenants` | Tenants |
| `PUT` | `/tenants/<int:idx>/status` | Status |
| `GET` | `/collections/log` | Log |
