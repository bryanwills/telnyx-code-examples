...
| [make-outbound-phone-call-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/make-outbound-phone-call-python/README.md) | Python | Initiate outbound calls via the Call Control API. |
...
| [edge-compliance-monitor-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-compliance-monitor-python/README.md) | Python | ---. |
| [edge-fraud-firewall-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-fraud-firewall-python/README.md) | Python | ---. |
| [edge-geo-smart-router-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-geo-smart-router-python/README.md) | Python | ---. |
| [edge-ivr-ab-tester-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-ivr-ab-tester-python/README.md) | Python | ---. |
| [edge-merge-ai-receptionist-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-merge-ai-receptionist-python/README.md) | Python | ---. |
| [edge-merge-reference-checker-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-merge-reference-checker-python/README.md) | Python | ---. |
| [edge-merge-shift-coverage-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-merge-shift-coverage-python/README.md) | Python | ---. |
| [edge-number-masking-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-number-masking-python/README.md) | Python | ---. |
| [edge-voicemail-to-action-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-voicemail-to-action-python/README.md) | Python | ---. |
| [edge-webhook-aggregator-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/edge-webhook-aggregator-python/README.md) | Python | ---. |
| [merge-deal-desk-alerts-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-deal-desk-alerts-python/README.md) | Python | ---. |
| [merge-employee-hotline-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-employee-hotline-python/README.md) | Python | ---. |
| [merge-expense-by-phone-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-expense-by-phone-python/README.md) | Python | ---. |
| [merge-interview-pipeline-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-interview-pipeline-python/README.md) | Python | ---. |
| [merge-invoice-collector-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-invoice-collector-python/README.md) | Python | ---. |
| [merge-pipeline-briefing-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-pipeline-briefing-python/README.md) | Python | ---. |
| [merge-recruitment-hotline-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-recruitment-hotline-python/README.md) | Python | ---. |
| [merge-ticket-escalation-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-ticket-escalation-python/README.md) | Python | ---. |
| [route-phone-calls-to-ai-agent-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-nodejs/README.md) | Node.js | Handle inbound calls with webhook-driven AI routing. |
| [make-outbound-phone-call-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/make-outbound-phone-call-nodejs/README.md) | Node.js | Initiate outbound calls via the Call Control API. |
| [make-outbound-phone-call-java](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/make-outbound-phone-call-java/README.md) | Java | Initiate outbound calls via the Call Control API. |
| [make-outbound-phone-call-csharp](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/make-outbound-phone-call-csharp/README.md) | C# | Initiate outbound calls via the Call Control API. |
| [make-outbound-phone-call-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/make-outbound-phone-call-ruby/README.md) | Ruby | Initiate outbound calls via the Call Control API. |
| [build-ivr-phone-menu-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/build-ivr-phone-menu-nodejs/README.md) | Node.js | Build an interactive voice response menu with DTMF input. |
| [record-phone-calls-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-nodejs/README.md) | Node.js | Record calls and receive recording webhooks. |
| [text-to-speech-phone-call-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/text-to-speech-phone-call-nodejs/README.md) | Node.js | Play text-to-speech audio during a phone call. |
| [route-phone-calls-to-ai-agent-go](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-go/README.md) | Go | Handle inbound calls with webhook-driven AI routing. |
| [route-phone-calls-to-ai-agent-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-ruby/README.md) | Ruby | Handle inbound calls with webhook-driven AI routing. |
| [make-outbound-phone-call-php](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/make-outbound-phone-call-php/README.md) | PHP | Initiate outbound calls via the Call Control API. |
...
| [call-analytics-dashboard-api-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/call-analytics-dashboard-api-python/README.md) | Python | SMS application. Built with Telnyx CDR, Migration, Number Porting, SMS/MMS. |
...
| [porting-order-tracker-dashboard-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/porting-order-tracker-dashboard-python/README.md) | Python | Porting Order Tracker Dashboard â submit, track, and manage porting orders with SLA monitoring, timeline visualization, and bulk operations. |
...
| Example | Language | Description |
|---------|----------|-------------|
| [send-sms-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-python/README.md) | Python | Send a single SMS message via the Telnyx API. |
...
| [send-mms-picture-message-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-mms-picture-message-python/README.md) | Python | Send MMS messages with media attachments. |
...
| [merge-employee-onboarding-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/merge-employee-onboarding-python/README.md) | Python | ---. |
| [send-sms-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-nodejs/README.md) | Node.js | Send a single SMS message via the Telnyx API. |
| [receive-sms-webhook-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/receive-sms-webhook-nodejs/README.md) | Node.js | Receive inbound SMS via webhook. |
| [receive-sms-webhook-csharp](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/receive-sms-webhook-csharp/README.md) | C# | Receive inbound SMS via webhook (Ed25519-verified). |
| [sms-two-factor-auth-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-two-factor-auth-nodejs/README.md) | Node.js | Implement SMS-based two-factor authentication. |
| [send-bulk-sms-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-bulk-sms-nodejs/README.md) | Node.js | Send SMS messages to multiple recipients. |
| [receive-sms-webhook-java](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/receive-sms-webhook-java/README.md) | Java | Receive inbound SMS via webhook with Ed25519 signature verification. |
| [receive-sms-webhook-php](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/receive-sms-webhook-php/README.md) | PHP | Receive inbound SMS via webhook with Ed25519 signature verification. |
| [receive-sms-webhook-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/receive-sms-webhook-ruby/README.md) | Ruby | Receive inbound SMS via webhook with Ed25519 signature verification. |
| [send-sms-go](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-go/README.md) | Go | Send a single SMS message via the Telnyx API. |
| [send-sms-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-ruby/README.md) | Ruby | Send a single SMS message via the Telnyx API. |
| [send-sms-csharp](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-csharp/README.md) | C# | Send a single SMS message via the Telnyx API. |
| [send-sms-java](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-java/README.md) | Java | Send a single SMS message via the Telnyx API. |
| [send-sms-php](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-php/README.md) | PHP | Send a single SMS message via the Telnyx API. |
...
| [e911-address-validator-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/e911-address-validator-python/README.md) | Python | Application. Built with Telnyx E911, Migration, Number Porting. |
...
| [hotel-guest-services-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/hotel-guest-services-python/README.md) | Python | Room service, housekeeping, concierge requests via voice or SMS. AI routes and tracks. Staff gets Slack notifications, guest gets SMS when fulfilled. |
...
| [sms-poll-voting-system-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-poll-voting-system-python/README.md) | Python | SMS Poll Voting System — text-to-vote polling with real-time results. |
...
| [two-way-sms-chat-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/two-way-sms-chat-python/README.md) | Python | pip install -r requirements.txt. |
| [sms-survey-bot-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-survey-bot-python/README.md) | Python | pip install -r requirements.txt. |
| [schedule-sms-messages-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/schedule-sms-messages-python/README.md) | Python | pip install -r requirements.txt. |
| [alphanumeric-sender-id-sms-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/alphanumeric-sender-id-sms-python/README.md) | Python | pip install -r requirements.txt. |
| [long-code-sms-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/long-code-sms-python/README.md) | Python | pip install -r requirements.txt. |
| [toll-free-sms-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/toll-free-sms-python/README.md) | Python | pip install -r requirements.txt. |
| [shortcode-sms-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/shortcode-sms-python/README.md) | Python | pip install -r requirements.txt. |
| [receive-mms-webhook-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/receive-mms-webhook-python/README.md) | Python | pip install -r requirements.txt. |
| [sms-delivery-receipts-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-delivery-receipts-python/README.md) | Python | pip install -r requirements.txt. |
| [phone-number-lookup-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/phone-number-lookup-python/README.md) | Python | pip install -r requirements.txt. |
| [sms-opt-out-management-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-opt-out-management-python/README.md) | Python | pip install -r requirements.txt. |
| [sms-conversation-threading-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-conversation-threading-python/README.md) | Python | pip install -r requirements.txt. |
| [send-sms-notifications-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-notifications-python/README.md) | Python | pip install -r requirements.txt. |
| [sms-marketing-campaign-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-marketing-campaign-python/README.md) | Python | pip install -r requirements.txt. |
| [two-way-sms-chat-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/two-way-sms-chat-nodejs/README.md) | Node.js | npm install. |
| [send-mms-picture-message-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-mms-picture-message-nodejs/README.md) | Node.js | npm install. |
| [sms-auto-reply-bot-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-auto-reply-bot-nodejs/README.md) | Node.js | npm install. |
| [sms-delivery-receipts-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-delivery-receipts-nodejs/README.md) | Node.js | npm install. |
...
| Example | Language | Description |
|---------|----------|-------------|
| [create-ai-assistant-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/create-ai-assistant-python/README.md) | Python | Create a new AI assistant with custom instructions. |
| [chat-with-ai-assistant-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-python/README.md) | Python | Send messages to an AI assistant and receive responses. |
| [list-ai-assistants-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/list-ai-assistants-python/README.md) | Python | List and manage your AI assistants. |
...
| [update-ai-assistant-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/update-ai-assistant-python/README.md) | Python | Update an AI assistant's instructions and settings. |
| [create-ai-assistant-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/create-ai-assistant-nodejs/README.md) | Node.js | Create a new AI assistant with custom instructions. |
| [chat-with-ai-assistant-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-nodejs/README.md) | Node.js | Send messages to an AI assistant and receive responses. |
| [chat-with-ai-assistant-php](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-php/README.md) | PHP | Send messages to an AI assistant and receive responses, keeping conversation context. |
| [list-ai-assistants-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/list-ai-assistants-nodejs/README.md) | Node.js | List and manage your AI assistants. |
| [chat-with-ai-assistant-java](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-java/README.md) | Java | Send messages to an AI assistant and thread a multi-turn conversation. |
| [chat-with-ai-assistant-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-ruby/README.md) | Ruby | Chat with an AI assistant and maintain conversation context via a Sinatra endpoint. |
| [chat-with-ai-assistant-go](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-go/README.md) | Go | Send messages to an AI assistant and maintain multi-turn context with a conversation id via a Gin endpoint. |
...
| [ai-tech-support-voice-agent-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-tech-support-voice-agent-python/README.md) | Python | Voice application powered by Telnyx AI Inference. Built with Telnyx AI Assistants, AI Inference, Migration, Number Porting. |
...
| [build-voice-ai-agent-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/build-voice-ai-agent-nodejs/README.md) | Node.js | npm install. |
...
| [omnichannel-ai-receptionist-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/omnichannel-ai-receptionist-python/README.md) | Python | Voice and SMS application powered by Telnyx AI Inference. Built with Telnyx AI Assistants, AI Inference, Migration, Number Porting. |
...
| [run-llm-inference-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/run-llm-inference-nodejs/README.md) | Node.js | run llm inference nodejs. |
| [run-llm-inference-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/run-llm-inference-python/README.md) | Python | Application powered by Telnyx AI Inference. Built with Telnyx AI Inference, Migration, Number Porting, SMS/MMS. |
...
| [texml-voicemail-drop-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/texml-voicemail-drop-python/README.md) | Python | TeXML Voicemail Drop — leave pre-recorded voicemails at scale via TeXML. |
...
| Example | Language | Description |
|---------|----------|-------------|
| [setup-sip-trunk-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-python/README.md) | Python | Set up a SIP trunk connection with Telnyx. |
...
| [setup-sip-trunk-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-nodejs/README.md) | Node.js | Set up a SIP trunk connection with Telnyx. |
| [inbound-sip-routing-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/inbound-sip-routing-nodejs/README.md) | Node.js | Route inbound SIP calls to your endpoints. |
| [setup-sip-trunk-go](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-go/README.md) | Go | Set up a SIP trunk connection with Telnyx. |
| [setup-sip-trunk-java](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-java/README.md) | Java | Set up a SIP trunk connection with Telnyx. |
| [setup-sip-trunk-csharp](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-csharp/README.md) | C# | Set up a SIP trunk connection with Telnyx. |
| [setup-sip-trunk-php](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-php/README.md) | PHP | Create, list, and retrieve a Telnyx credential (SIP) connection. |
| [setup-sip-trunk-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/setup-sip-trunk-ruby/README.md) | Ruby | Create, list, and retrieve a Telnyx credential (SIP) connection. |
...
| [monitor-iot-data-usage-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/monitor-iot-data-usage-python/README.md) | Python | Monitor data usage for IoT SIM cards. |
...
| [track-iot-device-location-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/track-iot-device-location-python/README.md) | Python | Track the geographic location of IoT devices. |
| [activate-sim-card-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/activate-sim-card-nodejs/README.md) | Node.js | Activate a SIM card on the Telnyx network. |
| [monitor-iot-data-usage-nodejs](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/monitor-iot-data-usage-nodejs/README.md) | Node.js | Monitor data usage for IoT SIM cards. |
| [activate-sim-card-go](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/activate-sim-card-go/README.md) | Go | Activate a SIM card on the Telnyx network. |
| [activate-sim-card-csharp](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/activate-sim-card-csharp/README.md) | C# | Enable (activate) a SIM card on the Telnyx network. |
| [activate-sim-card-php](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/activate-sim-card-php/README.md) | PHP | Activate a SIM card on the Telnyx network. |
| [activate-sim-card-java](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/activate-sim-card-java/README.md) | Java | Activate a SIM card on the Telnyx network. |
| [activate-sim-card-ruby](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/activate-sim-card-ruby/README.md) | Ruby | Enable (activate) a SIM card on the Telnyx network. |
...
| [wireless-fleet-activation-portal-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/wireless-fleet-activation-portal-python/README.md) | Python | Wireless Fleet Activation Portal — bulk activate SIMs with status tracking. |
