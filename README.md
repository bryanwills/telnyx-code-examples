...
| [ai-pre-visit-clearance-voice-agent-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-pre-visit-clearance-voice-agent-python/README.md) | Python | AI Pre-Visit Clearance Voice Agent - inbound voice agent for healthcare pre-visit insurance clearance. Verifies patient by DOB, collects procedure/provider/insurer, classifies urgency with AI, creates a structured intake ticket for billing staff, and sends an SMS confirmation. |
...
| [semantic-search-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/semantic-search-python/README.md) | Python | Semantic Search - index support tickets via Telnyx embeddings API and find similar issues by meaning, not keywords. |
