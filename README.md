...
| [network-incident-agent](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/network-incident-agent/README.md) | Python | An AI agent that acts as the incident itself, proactively notifying affected customers via SMS, handling inbound calls with incident context, and generating RCA documents. |
