...
<details open>
<summary><h2>AI Assistants</h2> <em>(123 examples)</em></summary>
...
| [ai-past-due-payment-collection-voice-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-past-due-payment-collection-voice-python/README.md) | Python | PCI-aware payment collection assistant that starts Telnyx Pay over Voice for secure keypad card entry and logs only sanitized payment events. |
...
| [call-recording-redactor-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/call-recording-redactor-python/README.md) | Python | AI Call Recording Redactor - transcribe call audio and redact PII via Telnyx STT and AI Inference. |
...
| [voicemail-smart-router-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voicemail-smart-router-python/README.md) | Python | AI Voicemail Smart Router - transcribe voicemails, classify intent, and route to the right channel via Telnyx STT and AI Inference. |
