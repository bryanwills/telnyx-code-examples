...
| [conversation-relay-voice-bot-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/conversation-relay-voice-bot-python/README.md) | Python | Turn a Text Chatbot Into a Voice Bot With Conversation Relay — forward live phone calls to any existing text-in/text-out AI chatbot using Telnyx Conversation Relay, no changes to the bot. |
...
| [ai-content-translator-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-content-translator-python/README.md) | Python | AI Content Translator - upload any audio (podcast, meeting, lecture), STT transcribes in source language (Whisper), AI Inference translates, REST TTS generates a downloadable dubbed mp3 in target language. Polished drag/drop UI at GET /. |
...
| [ai-subscription-cancel-save-retention-agent-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-subscription-cancel-save-retention-agent-python/README.md) | Python | AI Subscription Cancel-Save Retention Agent - inbound voice agent that handles cancellation requests, classifies the reason with AI, offers one eligible save option, and records the outcome. |
