...
Call a number and speak natural language commands to control IoT devices. AI parses intent (open door, set temperature, check status) and dispatches to devices via SIM API.
...
| Product | Role |
|---------|------|
| Voice API | Command interface |
| Inference | Intent parsing |
| IoT SIM | Device control |
