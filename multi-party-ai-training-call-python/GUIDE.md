...
A production-ready **multi-party ai training call** built with Python, Flask, and Voice, AI Inference, Conferencing.
...
| **Products** | Voice, AI Inference, Conferencing |
| **Channels** | voice |
...
The entire app is in `app.py` (249 lines). Here's how it's structured:

### Endpoints

| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/training/start` | Start |
| `POST` | `/webhooks/voice` | Telnyx webhook handler |
| `GET` | `/training/<sid>` | <Sid> |
...
- **`list_sessions_view()`** — list sessions view
