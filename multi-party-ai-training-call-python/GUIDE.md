# Build a Multi-Party AI Training Call
...
Everything lives in `app.py` (249 lines). Here's what each piece does.
...
```bash
curl http://localhost:5000/training/<sid> | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/multi-party-ai-training-call-python/README.md)
