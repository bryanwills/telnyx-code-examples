...
Call to RSVP for an event. AI collects guest name, party size, dietary restrictions, and accessibility needs. Auto-extracts structured RSVP data with guest count totals.
