# Build an AI Event RSVP Phone Line
...
- **`list_rsvps()`** — Returns all rsvps with metadata and pagination.
...
```bash
curl http://localhost:5000/rsvps | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-event-rsvp-phone-line-python/README.md)
