...
A production-ready **ai event rsvp phone line** built with Python, Flask, and AI Inference.
...
curl -X GET http://localhost:5000/rsvps \
...
```bash
docker build -t ai-event-rsvp-phone-line-python .
docker run --env-file .env -p 5000:5000 ai-event-rsvp-phone-line-python
```
