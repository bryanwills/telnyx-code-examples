# Build a Voice Journal Daily Log
...
cd telnyx-code-examples/voice-journal-daily-log-python
cp .env.example .env
...
- **`list_entries()`** — Returns all entries with metadata and pagination.
- **`insights()`** — Returns all entries with metadata and pagination.
...
```bash
curl http://localhost:5000/journal | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-journal-daily-log-python/README.md)
