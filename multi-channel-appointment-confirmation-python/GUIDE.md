...
A production-ready **multi-channel appointment confirmation** built with Python, Flask, and SMS/MMS, Voice.
...
| `POST` | `/confirm/<aid>` | <Aid> |
| `POST` | `/escalate/<aid>` | <Aid> |
...
- **`send_sms()`** — send sms
- **`make_confirmation_call()`** — make confirmation call
- **`create_appointment()`** — create appointment
- **`send_confirmation()`** — send confirmation
- **`escalate_to_voice()`** — escalate to voice
- **`handle_sms_reply()`** — handle sms reply
