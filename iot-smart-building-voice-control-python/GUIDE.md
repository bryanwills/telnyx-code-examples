...
A production-ready **iot smart building voice control** built with Python, Flask, and AI Inference.
...
curl -X GET http://localhost:5000/building/state \
