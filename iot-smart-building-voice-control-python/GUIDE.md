# Build an IoT Smart Building Voice Control

IoT Smart Building Voice Control — call a number to control building systems via AI + IoT SIMs.
...
```python
    ...
    if event_type == "call.initiated" and data.get("direction") == "incoming":
        ...
        client.calls.actions.speak(ccid, payload="Building control connected. What would you like to adjust?", voice="female", language_code="en-US")
...
```bash
curl http://localhost:5000/building/state | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/iot-smart-building-voice-control-python/README.md)
