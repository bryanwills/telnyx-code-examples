# Build an AI Restaurant Reservation Voice Agent
...
```bash
curl http://localhost:5000/reservations | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-restaurant-reservation-voice-agent-python/README.md)
