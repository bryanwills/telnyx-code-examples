...
```bash
docker build -t ai-restaurant-reservation-voice-agent .
docker run --env-file .env -p 5000:5000 ai-restaurant-reservation-voice-agent
```
...
| `RESTAURANT_NUMBER` | Phone number in E.164 format | Yes |
