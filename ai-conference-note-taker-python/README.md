---
name: ai-conference-note-taker
title: "AI Conference Note-Taker"
...
| `NOTETAKER_NUMBER` | `string` | `your_value` | **yes** | Notetaker number | — |
...
**Events handled:** `call.answered`, `call.hangup`, `call.transcription`
