...
A production-ready **ai conference note-taker** built with Python, Flask, and SMS/MMS, Voice, AI Inference.
...
| **Products** | SMS/MMS, Voice, AI Inference |
| **Channels** | voice |
...
The entire app is in `app.py` (192 lines). Here's how it's structured:
...
- **`generate_meeting_notes()`** — generate meeting notes
- **`send_sms()`** — send sms
