# Build a Post-Service Follow-Up Engine
...
Everything lives in `app.py` (143 lines). Here's what each piece does.

### Starting the Workflow

**`create_jira_ticket()`** — Kicks off the main workflow. Validates the request, creates the record, and initiates the Telnyx API calls.
...
```bash
curl http://localhost:5000/follow-ups | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/post-service-followup-engine-python/README.md)
