...
A production-ready **post-service follow-up engine** built with Python, Flask, and Voice, AI Inference.

Integrates with Jira, HubSpot, Slack for extended functionality.
...
The entire app is in `app.py` (143 lines). Here's how it's structured:

### Endpoints

| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/follow-up/send` | Send |
...
- Extend Jira, HubSpot, Slack integration with richer workflows
