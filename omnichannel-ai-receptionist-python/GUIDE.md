...
A production-ready **omnichannel ai receptionist — one ai brain across voice, sms, and whatsapp** built with Python, Flask, and SMS/MMS, AI Inference.
...
The entire app is in `app.py` (186 lines). Here's how it's structured:
