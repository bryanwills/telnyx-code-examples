...
A production-ready **ai compliance quiz phone** built with Python, Flask, and AI Inference.
...
curl -X GET http://localhost:5000/completions \
...
```bash
docker build -t ai-compliance-quiz-phone-python .
docker run --env-file .env -p 5000:5000 ai-compliance-quiz-phone-python
```
