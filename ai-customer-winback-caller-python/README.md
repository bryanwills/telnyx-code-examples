...
```bash
docker build -t ai-customer-winback-caller .
docker run --env-file .env -p 5000:5000 ai-customer-winback-caller
```
...
| `WINBACK_NUMBER` | Phone number in E.164 format | Yes |
