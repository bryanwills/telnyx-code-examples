---
name: ai-customer-winback-caller
title: "AI Customer Winback Caller"
description: "AI Customer Winback Caller — AI calls churned customers with personalized re-engagement offers."
language: python
framework: flask
...
| `WINBACK_NUMBER` | `string` | `your_value` | **yes** | Winback number | — |
...
```bash
docker build -t ai-customer-winback-caller-python .
docker run --env-file .env -p 5000:5000 ai-customer-winback-caller-python
```
