...
A production-ready **ai customer winback caller** built with Python, Flask, and Voice, AI Inference.
...
The entire app is in `app.py` (81 lines). Here's how it's structured:

### Endpoints

| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/winback` | Winback |
