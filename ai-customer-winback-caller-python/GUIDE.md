# Build an AI Customer Winback Caller
...
Everything lives in `app.py` (81 lines). Here's what each piece does.

### Starting the Workflow

**`start_winback()`** — Kicks off the main workflow. Validates the request, creates the record, and initiates the Telnyx API calls.
...
```bash
curl -X POST http://localhost:5000/winback \
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-customer-winback-caller-python/README.md)
