---
name: webrtc-ai-interpreter-live-calls
title: "WebRTC AI Interpreter for Live Calls"
...
```bash
docker build -t webrtc-ai-interpreter-live-calls-python .
docker run --env-file .env -p 5000:5000 webrtc-ai-interpreter-live-calls-python
```
...
**Events handled:** `call.answered`, `call.hangup`, `call.initiated`, `call.speak.ended`, `call.transcription`
