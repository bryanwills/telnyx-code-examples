# Build a WebRTC AI Interpreter for Live Calls
...
**`start_interpreted_call()`** — Kicks off the main workflow. Validates the request, creates the record, and initiates the Telnyx API calls.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/webrtc-ai-interpreter-live-calls-python/README.md)
