...
A production-ready **sms trivia game tournament** built with Python, Flask, and SMS/MMS, AI Inference.
...
The entire app is in `app.py` (106 lines). Here's how it's structured:

### Endpoints

| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/tournament/create` | Create |
| `POST` | `/webhooks/messaging` | Telnyx webhook handler |
| `POST` | `/tournament/<tid>/next` | Next |
