...
A production-ready **mms receipt scanner & expense tracker** built with Python, Flask, and SMS/MMS, AI Inference.
...
The entire app is in `app.py` (102 lines). Here's how it's structured:
