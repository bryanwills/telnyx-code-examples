# Build an AI Podcast Post-Producer
...
- **`produce_episode()`** — Processes produce episode request and returns result.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-podcast-post-producer-python/README.md)
