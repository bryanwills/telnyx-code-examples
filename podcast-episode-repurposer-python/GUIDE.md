# Build a Podcast Episode Repurposer
...
```bash
curl http://localhost:5000/repurpose/<job_id> | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/podcast-episode-repurposer-python/README.md)
