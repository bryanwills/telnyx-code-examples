---
name: ai-medical-appointment-prep-caller
title: "AI Medical Appointment Prep Caller"
description: "AI Medical Appointment Prep Caller — calls patients before appointments to collect intake info."
language: python
framework: flask
...
| `CLINIC_NUMBER` | `string` | `your_value` | **yes** | Clinic number | — |
...
```bash
docker build -t ai-medical-appointment-prep-caller-python .
docker run --env-file .env -p 5000:5000 ai-medical-appointment-prep-caller-python
```
