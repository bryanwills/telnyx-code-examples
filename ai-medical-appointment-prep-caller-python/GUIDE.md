...
A production-ready **ai medical appointment prep caller** built with Python, Flask, and Voice, AI Inference.
...
- **`start_prep_call()`** — start prep call
- **`handle_voice()`** — handle voice
- **`list_intakes()`** — list intakes
- **`health()`** — health
