...
```bash
docker build -t ai-language-learning-phone-tutor .
docker run --env-file .env -p 5000:5000 ai-language-learning-phone-tutor
```
...
| `TUTOR_NUMBER` | Phone number in E.164 format | Yes |
