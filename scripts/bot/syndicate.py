...
def syndicate(sample_name: str, assignee: str, dry_run: bool = False) -> str:
    ...
    pr_body = (
        f"Auto-generated syndication content for `{sample_name}`.\n\n"
        f"**Source**: https://github.com/team-telnyx/telnyx-code-examples/tree/main/{sample_name}\n"
        f"**Assignee**: {assignee}\n\n"
        f"Generated by `telnyx-devrel-bot[bot]` via the ACP Hermes agent.\n\n"
        f"---\n\n"
        f"Contains:\n"
        f"- README.md — syndication package overview\n"
        f"- blog-post.md — technical walkthrough for Telnyx Blog / Dev.to\n"
        f"- medium-article.md — narrative developer story for Medium\n"
        f"- hackernews-post.md — Show HN post\n"
        f"- youtube-script.md — YouTube demo script"
    )
