# Build a Prescription Refill Line
...
```bash
curl http://localhost:5000/refills | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/prescription-refill-line-python/README.md)
