...
A production-ready **number lookup lead enrichment** built with Python, Flask, and AI Inference, Number Lookup.
...
| **Products** | AI Inference, Number Lookup |
...
The entire app is in `app.py` (63 lines). Here's how it's structured:
