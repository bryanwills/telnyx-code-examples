# Build an Autonomous Outbound Sales Agent
...
Everything lives in `app.py` (265 lines). Here's what each piece does.

### Starting the Workflow

**`start_campaign()`** — Kicks off the main workflow. Validates the request, creates the record, and initiates the Telnyx API calls.
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/autonomous-outbound-sales-agent-python/README.md)
