# Build an AI Meeting Action Tracker
...
Everything lives in `app.py` (219 lines). Here's what each piece does.

### Starting the Workflow

**`create_meeting()`** — Kicks off the main workflow. Validates the request, creates the record, and initiates the Telnyx API calls.
...
```bash
curl http://localhost:5000/meetings/<mid> | python3 -m json.tool
```
...
- [Source code and reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-meeting-action-tracker-python/README.md)
