...
A production-ready **ai meeting action tracker** built with Python, Flask, and Voice, AI Inference, Conferencing.
...
The entire app is in `app.py` (219 lines). Here's how it's structured:
