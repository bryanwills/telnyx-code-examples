...
```bash
docker build -t voice-to-slack-bridge .
docker run --env-file .env -p 5000:5000 voice-to-slack-bridge
```
...
| `BRIDGE_NUMBER` | Phone number in E.164 format | Yes |
