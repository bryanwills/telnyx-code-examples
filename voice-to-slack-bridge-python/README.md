...
Call a number, speak a message, AI classifies urgency and posts it to Slack. Critical messages get :rotating_light:, routine ones get :speech_balloon:.
...
| Product | Role |
|---------|------|
| Voice API | Inbound message capture |
| Inference | Urgency classification |
...
- [Ai Standup Facilitator Phone](../ai-standup-facilitator-phone-python/)
