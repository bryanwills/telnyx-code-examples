...
```bash
docker build -t ai-insurance-claims-intake-voice .
docker run --env-file .env -p 5000:5000 ai-insurance-claims-intake-voice
```
...
| `CLAIMS_NUMBER` | Phone number in E.164 format | Yes |
