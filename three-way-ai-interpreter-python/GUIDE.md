...
A production-ready **three-way call with ai interpreter** built with Python, Flask, and Voice, AI Inference, Conferencing.
...
The entire app is in `app.py` (245 lines). Here's how it's structured:

### Endpoints

| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `/interpret/start` | Start |
| `POST` | `/webhooks/voice` | Telnyx webhook handler |
| `GET` | `/sessions` | Sessions |
| `GET` | `/sessions/<sid>/transcript` | Transcript |
