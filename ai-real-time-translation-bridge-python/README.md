...
Connect two callers who speak different languages. Each person speaks naturally; AI translates and plays the translation to the other party in real time.
...
| Product | Role |
|---------|------|
| Voice API | Dual-leg call management |
| Inference | Real-time translation |
| Call Control | Speech + gather per leg |
...
- [Webrtc Ai Interpreter Live Calls](../webrtc-ai-interpreter-live-calls-python/)
