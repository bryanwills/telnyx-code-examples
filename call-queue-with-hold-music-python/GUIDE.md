...
A production-ready **call queue with hold music** built with Python, Flask, and Cloud Storage, Migration, Number Porting, Voice.
...
- **`get_available_agent()`** — get available agent
