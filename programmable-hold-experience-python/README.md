...
Custom hold experiences beyond hold music: rotating tips, trivia, estimated wait times, and callback offers. Press 9 to request a callback instead of waiting.
...
| Product | Role |
|---------|------|
| Voice API | Hold queue management |
| Playback | Music + speech rotation |
| DTMF | Callback request |
