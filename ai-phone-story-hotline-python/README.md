...
Call a hotline, choose a genre (mystery, sci-fi, fantasy, horror, romance), and listen to an AI-generated interactive story. Your DTMF choices shape the narrative across 5 chapters.
...
| Product | Role |
|---------|------|
| Voice API | Interactive storytelling |
| Inference | Dynamic narrative generation |
| DTMF | Choice-driven branching |
...
- [Sms Escape Room Game](../sms-escape-room-game-python/)
- [Ai Language Learning Phone Tutor](../ai-language-learning-phone-tutor-python/)
